...
common_derives! {
    pub enum Template {
        ...
        NcharMinutesSystem(NcharMinutesSystem),
        NcharActionItemsSystem(NcharActionItemsSystem),
...
pub fn render(t: Template) -> Result<String, Error> {
    let value = match t {
        ...
        Template::NcharMinutesSystem(t) => askama::Template::render(&t),
        Template::NcharActionItemsSystem(t) => askama::Template::render(&t),
